...
export default function Cta() {
  ...
  const stats = [
    { value: '15K+', label: 'Small Businesses', icon: TrendingUp },
    { value: '99.8%', label: 'Payment Success', icon: CheckCircle },
    { value: '2.5x', label: 'Faster Payments', icon: Clock },
    { value: '$2M+', label: 'Invoices Processed', icon: DollarSign },
  ];
          ...
          <CardContent className="relative p-12 lg:p-16">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-12 leading-relaxed">
                Join thousands of small businesses and freelancers who trust Invoicely to manage
        ...
        <div className="text-center mt-16">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Professional invoices that get you paid 2.5x faster
              </p>
            </div>
          </div>
        </div>
